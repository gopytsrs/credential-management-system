...
const ProfileForm = () => {
  ...
  const {
    ...
    account: address,
    contractName: "OrganizationAccount",
    args: ["", "", "", ""],
  ...
  console.log(address, initialData);

  const onSubmit: SubmitHandler<IFormInput> = async data => {
    console.log(data);
    const { name, emailAddress, phoneNumber, website } = data;
    try {
      await createOrUpdateProfile({ args: [name, emailAddress, website, phoneNumber] });
